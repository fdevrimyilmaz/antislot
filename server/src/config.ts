...
const iapProductQuarterly = (process.env.IAP_PRODUCT_QUARTERLY || "antislot_premium_3m").trim();
const iapProductSemiannual = (process.env.IAP_PRODUCT_SEMIANNUAL || "antislot_premium_6m").trim();
